...
function Navbar() {
    ...
    return (
        <div className="border-b border-gray-200 dark:border-gray-500 bg-white dark:bg-[#16171a] shadow-md md:bg-white/10 dark:md:bg-white/10 backdrop-blur-sm sticky top-0 left-0 w-full z-50">
            <div className="flex items-center justify-between max-w-6xl mx-auto py-4 px-6 relative z-30">

                <div className="flex items-center gap-2">
                    <div className="text-white dark:text-black text-md py-1 px-1.5 bg-black dark:bg-gray-100 rounded-md font-semibold">
                        TP
                    </div>

                    <p className="text-md font-semibold text-black dark:text-gray-100">
                        Taras Poiatsyka
                    </p>
                </div>
                ...
                <div className="flex items-center md:hidden">
                    ...
                    <div
                        ref={menuRef}
                        className={`
                            absolute top-full left-0 w-full border-b border-gray-200/60 bg-white dark:bg-[#16171a]
                    ...
                    >
                        <ul className="flex flex-col items-start gap-2 p-4">
                            <li className={
                                current === 'home'
                                    ? 'bg-gray-100 dark:bg-[#222429] text-black dark:text-gray-100 rounded-md w-full'
                                    : 'text-gray-600 dark:text-gray-100 hover:text-black hover:bg-gray-50 rounded-md transition-colors duration-150 w-full'
                            }>
                                <Link
                                    href="/"
                ...
                <ul className="items-center gap-2 hidden md:flex">
                    <li className={
                        current === 'home'
                            ? 'bg-gray-300/20 dark:bg-gray-500/20 backdrop-blur-sm text-black dark:text-gray-100 rounded-md'
                            : 'text-gray-600 dark:text-gray-100 hover:text-black dark:hover:text-gray-100 hover:bg-gray-200/20 hover:dark:bg-gray-400/20 rounded-md transition-colors duration-150'
                    }>
