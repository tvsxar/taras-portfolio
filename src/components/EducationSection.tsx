                ...
                >
                    <div className="flex flex-col sm:flex-row sm:justify-between gap-4">
                        ...
                        <div className="flex gap-4">
                            <div className="rounded-lg bg-gray-100 dark:bg-[#1d1e22] dark:border-gray-500/20 dark:border p-3 h-fit">
                                <GraduationCap
                                    size={22}
                            ...
                            <div>
                                <h4 className="text-sm sm:text-base md:text-lg font-bold text-gray-900 dark:text-gray-100">
                                    B.S. Computer Science
                                </h4>

                                <p className="text-xs sm:text-sm text-gray-500 mt-1 dark:text-gray-300">
                                    Odessa Polytechnic National University
                                </p>

                                <p className="text-xs sm:text-sm text-gray-500 leading-relaxed mt-3 dark:text-gray-300">
                        ...
                        <div className="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-300 shrink-0">
                            2021 – 2025
                        </div>
